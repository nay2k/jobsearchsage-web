...
// node_modules/@unovis/ts/components/leaflet-map/renderer/leaflet-maplibre-gl.js
function MaplibreGLLayer(leaflet, maplibre, options) {
  const Layer = leaflet.Layer.extend({
    ...
    initialize: function(options2) {
      leaflet.setOptions(this, options2);
    ...
    _initGL: function() {
      ...
      const options2 = leaflet.extend({}, this.options, {
        container: this._container,
        center: [center.lng, center.lat],
        zoom: this._map.getZoom() - 1,
        attributionControl: false
      });
      this._glMap = new maplibre.Map(options2);
    ...
    _update: function(e) {
      ...
      if (gl.transform.width !== size.x || gl.transform.height !== size.y) {
        container.style.width = `${size.x}px`;
        container.style.height = `${size.y}px`;
        if (gl._resize !== null && gl._resize !== void 0) {
          gl._resize();
        } else {
          gl.resize();
        }
      } else {
        if (gl._update !== null && gl._update !== void 0) {
          gl._update();
        } else {
          gl.update();
        }
...
//# sourceMappingURL=mapboxgl-layer-2OSF4AO3.js.map
